...
/* 035 */   { ROOT  "AnB_hand.gif",		10, 0,  0, 10, 10,128,148 },
	    ...
	    { ROOT  "7lions_colors.gif",	10, 0,  0, 10, 10,  0,  0 },
	    { NULL,				10, 0,  0, 10, 10,128,128  },
	    { NULL,				10, 0,  0, 10, 10,128,128  },
...
/* 319 */   { ROOT  "DJ_7lions.gif",	        10, 0 , 0, 10, 10, 0, 0,  },
/* 320 */   { ROOT  "DJ_Above_and_Beyond3.gif",	10, 0 , 0, 10, 10, 0, 0  },
/* 321 */   { ROOT  "DJ_Afik_Cohen.gif",	10, 0 , 0, 10, 10, 0, 0  },
/* 322 */   { ROOT  "DJ_Alex_MORPH.gif",	10, 0 , 0, 10, 10, 0, 0  },
/* 323 */   { ROOT  "DJ_Alvin.gif",		10, 0 , 0, 10, 10, 0, 0  },
/* 324 */   { ROOT  "DJ_Aly_Fila_lgrey.gif",	10, 0 , 0, 10, 10,100,192 },
/* 325 */   { ROOT  "DJ_AlynFila_Fadi.gif",	10, 0 , 0, 10, 10, 0, 0  },
/* 326 */   { ROOT  "DJ_AndrewRayel.gif",	10, 0 , 0, 10, 10, 0, 0  },
/* 327 */   { ROOT  "DJ_Astrix.gif",		10, 0 , 0, 10, 10, 0, 0  },
/* 328 */   { ROOT  "DJ_ATB.gif",		10, 0 , 0, 10, 10, 0, 0,  },
/* 329 */   { ROOT  "DJ_AvB.gif",	    	10, 0 , 0, 10, 10, 0, 0  },
/* 330 */   { ROOT  "DJ_Blastoyz.gif",		10, 0 , 0, 10, 10, 0, 0,  },
/* 331 */   { ROOT  "DJ_CosmicGate.gif",	10, 0 , 0, 10, 10, 0, 0  },
/* 332 */   { ROOT  "DJ_Craig_Connelly.gif",	10, 0 , 0, 10, 10, 0, 0,  },
/* 333 */   { ROOT  "DJ_Dave_Dresden.gif",	10, 0 , 0, 10, 10, 0, 0  },
/* 334 */   { ROOT  "DJ_Emma_Hewitt.gif",	10, 0 , 0, 10, 10, 0, 0  },
/* 335 */   { ROOT  "DJ_FactorB.gif",		10, 0 , 0, 10, 10, 0, 0  },
/* 336 */   { ROOT  "DJ_FerryCorsten.gif",	10, 0 , 0, 10, 10, 0, 0  },
/* 337 */   { ROOT  "DJ_GarethEmery.gif",	10, 0 , 0, 10, 10, 0, 0  },
/* 338 */   { ROOT  "DJ_GO_face.gif",		10, 0 , 0, 10, 10, 0, 0  },
/* 339 */   { ROOT  "DJ_GO_lgrey.gif",		10, 0 , 0, 10, 10,128,117 },
/* 340 */   { ROOT  "DJ_JOC.gif",		10, 0 , 0, 10, 10, 0, 0,  },
/* 341 */   { ROOT  "DJ_John_00_Flemming.gif",	10, 0 , 0, 10, 10, 0, 0  },
/* 342 */   { ROOT  "DJ_Khromata.gif",		10, 0 , 0, 10, 10, 0, 0  },
/* 343 */   { ROOT  "DJ_Liquid_Soul.gif",	10, 0 , 0, 10, 10, 0, 0,  },
/* 344 */   { ROOT  "DJ_Marlo.gif",		10, 0 , 0, 10, 10, 0, 0,  },
/* 345 */   { ROOT  "DJ_Miyuki.gif",		10, 0 , 0, 10, 10, 0, 0,  },
/* 346 */   { ROOT  "DJ_PaulOakenfold.gif",	10, 0 , 0, 10, 10, 0, 0  },
/* 347 */   { ROOT  "DJ_PaulVanDyk.gif",	10, 0 , 0, 10, 10, 0, 0  },
/* 348 */   { ROOT  "DJ_RDR_lgrey.gif",		10, 0 , 0, 10, 10,128,128 },
/* 349 */   { ROOT  "DJ_Reality_Test.gif",	10, 0 , 0, 10, 10, 0, 0  },
/* 350 */   { ROOT  "DJ_Rinaly.gif",		10, 0 , 0, 10, 10, 0, 0  },
/* 351 */   { ROOT  "DJ_Ruben.gif",		10, 0 , 0, 10, 10,128,170 },
/* 352 */   { ROOT  "DJ_Solarstone.gif",	10, 0 , 0, 10, 10, 0, 0,  },
/* 353 */   { ROOT  "DJ_Somna.gif",		10, 0 , 0, 10, 10, 0, 0  },
/* 354 */   { ROOT  "DJ_Talla-2XLC.gif",	10, 0 , 0, 10, 10, 0, 0  },
/* 355 */   { ROOT  "DJ_Thrillseekers.gif",	10, 0 , 0, 10, 10, 0, 0  },
/* 356 */   { ROOT  "DJ_Triode.gif",	        10, 0 , 0, 10, 10, 0, 0,  },
/* 357 */   { ROOT  "DJ_vini_vici.gif",		10, 0 , 0, 10, 10,128,140 },
/* 358 */   { ROOT  "DJ_WhiteNo1se.gif",	10, 0 , 0, 10, 10, 0, 0  },
...
/* 437 */ { "", NULL, 317, NULL },
/* 438 */ { "", NULL, 318, NULL },
/* 439 */ { "GIF 7lions",            GifAnim, 319, NULL },
/* 440 */ { "GIF Above and Beyond",  GifAnim, 320, NULL },
/* 441 */ { "GIF Afik Cohen",        GifAnim, 321, NULL },
/* 442 */ { "GIF Alex MORPH",        GifAnim, 322, NULL },
/* 443 */ { "GIF Alvin",             GifAnim, 323, NULL },
/* 444 */ { "GIF Aly & Fila",        GifAnim, 324, NULL },
/* 445 */ { "GIF Aly & Fila Fadi",   GifAnim, 325, NULL },
/* 446 */ { "GIF Andrew Rayel",      GifAnim, 326, NULL },
/* 447 */ { "GIF Astrix",            GifAnim, 327, NULL },
/* 448 */ { "GIF ATB",               GifAnim, 328, NULL },
/* 449 */ { "GIF AvB",               GifAnim, 329, NULL },
/* 450 */ { "GIF Blastoyz",          GifAnim, 330, NULL },
/* 451 */ { "GIF Cosmic Gate",       GifAnim, 331, NULL },
/* 452 */ { "GIF Craig Connelly",    GifAnim, 332, NULL },
/* 453 */ { "GIF Dave Dresden",      GifAnim, 333, NULL },
/* 454 */ { "GIF Emma Hewitt",       GifAnim, 334, NULL },
/* 455 */ { "GIF FactorB",           GifAnim, 335, NULL },
/* 456 */ { "GIF Ferry Corsten",     GifAnim, 336, NULL },
/* 457 */ { "GIF Gareth Emery",      GifAnim, 337, NULL },
/* 458 */ { "GIF Giuseppe",          GifAnim, 338, NULL },
/* 459 */ { "GIF Giuseppe Logo",     GifAnim, 339, NULL },
/* 460 */ { "GIF JOC",               GifAnim, 340, NULL },
/* 461 */ { "GIF John 00 Flemming",  GifAnim, 341, NULL },
/* 462 */ { "GIF Khromata",          GifAnim, 342, NULL },
/* 463 */ { "GIF Liquid Soul",       GifAnim, 343, NULL },
/* 464 */ { "GIF Marlo",             GifAnim, 344, NULL },
/* 465 */ { "GIF Miyuki",            GifAnim, 345, NULL },
/* 466 */ { "GIF Paul Oakenfold",    GifAnim, 346, NULL },
/* 467 */ { "GIF Paul Van Dyk",      GifAnim, 347, NULL },
/* 468 */ { "GIF RDR Logo",          GifAnim, 348, NULL },
/* 469 */ { "GIF Reality Test",      GifAnim, 349, NULL },
/* 470 */ { "GIF Rinaly",            GifAnim, 350, NULL },
/* 471 */ { "GIF RubenDeRonde",      GifAnim, 351, NULL },
/* 472 */ { "GIF Solarstone",        GifAnim, 352, NULL },
/* 473 */ { "GIF Somna",             GifAnim, 353, NULL },
/* 474 */ { "GIF Talla-2XLC",        GifAnim, 354, NULL },
/* 475 */ { "GIF Thillseekers",      GifAnim, 355, NULL },
/* 476 */ { "GIF Triode",            GifAnim, 356, NULL },
/* 477 */ { "GIF Vini Vici",         GifAnim, 357, NULL },
/* 478 */ { "GIF WhiteNo1se",        GifAnim, 358, NULL },

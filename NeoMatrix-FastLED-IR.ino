...
/* 270 */   { ROOT  "F_Anna.gif"              , 10, 6,  9, 10, 10,140,210 },
/* 271 */   { ROOT  "F_Anna2.gif"             , 10, 6,  9, 10, 10,140,210 },
/* 272 */   { ROOT  "F_Anna3.gif"             , 10, 6,  9, 10, 10,140,210 },
/* 273 */   { ROOT  "F_Anna4.gif"             , 10, 6,  9, 10, 10,140,210 },
/* 274 */   { ROOT  "FIF5.gif"                , 10, 6,  9, 10, 10,140,210 },
/* 275 */   { ROOT  "FIF6.gif"                , 10, 6,  9, 10, 10,140,210 },
/* 276 */   { ROOT  "FIF7.gif"                , 10, 6,  9, 10, 10,140,210 },
/* 277 */   { ROOT  "FIF8.gif"                , 10, 6,  9, 10, 10,140,210 },
/* 278 */   { ROOT  "F_Thorgodofbass.gif"     , 10, 6,  9, 10, 10,140,210 },
/* 279 */   { ROOT  "F_AmandaVanderHeyden.gif", 10, 6,  9, 10, 10,140,210 },

/* 280 */   { ROOT  "DJ_00.gif",		10, 6,  9, 10, 10,140,210 },
/* 281 */   { ROOT  "DJ_01.gif",		10, 6,  9, 10, 10,140,210 },
/* 282 */   { ROOT  "DJ_02.gif",		10, 6,  9, 10, 10,140,210 },
/* 283 */   { ROOT  "DJ_03.gif",		10, 6,  9, 10, 10,140,210 },
/* 284 */   { ROOT  "DJ_04.gif",		10, 6,  9, 10, 10,140,210 },
/* 285 */   { ROOT  "DJ_05.gif",		10, 6,  9, 10, 10,140,210 },
/* 286 */   { ROOT  "DJ_06.gif",		10, 6,  9, 10, 10,140,210 },
/* 287 */   { ROOT  "DJ_07.gif",		10, 6,  9, 10, 10,140,210 },
/* 288 */   { ROOT  "DJ_08.gif",		10, 6,  9, 10, 10,140,210 },
/* 289 */   { ROOT  "DJ_09.gif",		10, 6,  9, 10, 10,140,210 },
              
/* 290 */   { ROOT  "DJ_7lions.gif",	        10, 6,  9, 10, 10,140,210 },
/* 291 */   { ROOT  "DJ_Above_and_Beyond3.gif",	10, 6,  9, 10, 10,140,210 },
/* 292 */   { ROOT  "DJ_Afik_Cohen.gif",	10, 6,  9, 10, 10,140,210 },
/* 293 */   { ROOT  "DJ_Alessandra_Roncone.gif",10, 6,  9, 10, 10,140,210 },
/* 294 */   { ROOT  "DJ_Alex_MORPH.gif",	10, 6,  9, 10, 10,140,210 },
/* 295 */   { ROOT  "DJ_Alpha9.gif",            10, 6,  9, 10, 10,140,210 },
/* 296 */   { ROOT  "DJ_Alvin.gif",		10, 6,  9, 10, 10,140,210 },
/* 297 */   { ROOT  "DJ_AlynFila_Fadi.gif",	10, 0 , 0, 10, 10,140,210 },
/* 298 */   { ROOT  "DJ_AlynFila_lgrey.gif",	10, 6,  9, 10, 10,100,192 },
/* 299 */   { ROOT  "DJ_Aname.gif",             10, 6,  9, 10, 10,140,210 },
/* 300 */   { ROOT  "DJ_AndrewRayel.gif",	10, 6,  9, 10, 10,140,210 },
/* 301 */   { ROOT  "DJ_Andy_Moor.gif",		10, 6,  9, 10, 10,140,210 },
/* 302 */   { ROOT  "DJ_Astrix.gif",		10, 6,  9, 10, 10,140,210 },
/* 303 */   { ROOT  "DJ_ATB.gif",		10, 6,  9, 10, 10,140,210 },
/* 304 */   { ROOT  "DJ_AvB.gif",	    	10, 6,  9, 10, 10,140,210 },
/* 305 */   { ROOT  "DJ_Ben_Nicky.gif",		10, 6,  9, 10, 10,140,210 },
/* 306 */   { ROOT  "DJ_Blastoyz.gif",		10, 6,  9, 10, 10,140,210 },
/* 307 */   { ROOT  "DJ_Blur.gif",              10, 6,  9, 10, 10,140,210 },
/* 308 */   { ROOT  "DJ_11.gif",                10, 6,  9, 10, 10,140,210 },
/* 309 */   { ROOT  "DJ_BryanKearney.gif",      10, 6,  9, 10, 10,140,210 },
/* 310 */   { ROOT  "DJ_Ciaran_McCauley.gif",	10, 6,  9, 10, 10,140,210 },
/* 311 */   { ROOT  "DJ_Cold_Blue.gif",		10, 6,  9, 10, 10,140,210 },
/* 312 */   { ROOT  "DJ_CosmicGate.gif",	10, 6,  9, 10, 10,140,210 },
/* 313 */   { ROOT  "DJ_Craig_Connelly.gif",	10, 6,  9, 10, 10,140,210 },
/* 314 */   { ROOT  "DJ_Crystal_Method.gif",	10, 6,  9, 10, 10,140,210 },
/* 315 */   { ROOT  "DJ_Dave_Dresden.gif",	10, 6,  9, 10, 10,140,210 },
/* 316 */   { ROOT  "DJ_Daxson.gif",            10, 6,  9, 10, 10,140,210 },
/* 317 */   { ROOT  "DJ_Emma_Hewitt.gif",	10, 6,  9, 10, 10,140,210 },
/* 318 */   { ROOT  "DJ_FactorB.gif",		10, 6,  9, 10, 10,140,210 },
/* 319 */   { ROOT  "DJ_FerryCorsten.gif",	10, 6,  9, 10, 10,140,210 },
/* 320 */   { ROOT  "DJ_Ferry_Tayle.gif",       10, 6,  9, 10, 10,140,210 },
/* 321 */   { ROOT  "DJ_Gareth_Emery.gif",	10, 6,  9, 10, 10,140,210 },
/* 322 */   { ROOT  "DJ_Giuseppe.gif",		10, 6,  9, 10, 10,140,210 },
/* 323 */   { ROOT  "DJ_Giuseppe_Logo.gif",	10, 0 , 0, 10, 10,128,117 },
/* 324 */   { ROOT  "DJ_Haliene.gif",		10, 6,  9, 10, 10,140,210 },
/* 325 */   { ROOT  "DJ_Ilan_Bluestone.gif",	10, 6,  9, 10, 10,140,210 },
/* 326 */   { ROOT  "DJ_JOC.gif",		10, 6,  9, 10, 10,140,210 },
/* 327 */   { ROOT  "DJ_Johan_Gielen.gif",	10, 6,  9, 10, 10,140,210 },
/* 328 */   { ROOT  "DJ_John_00_Flemming.gif",	10, 6,  9, 10, 10,140,210 },
/* 329 */   { ROOT  "DJ_Khromata.gif",		10, 6,  9, 10, 10,140,210 },
/* 330 */   { ROOT  "DJ_Lange.gif",             10, 6,  9, 10, 10,140,210 },
/* 331 */   { ROOT  "DJ_Liquid_Soul.gif",	10, 6,  9, 10, 10,140,210 },
/* 332 */   { ROOT  "DJ_Markus_Schulz.gif",     10, 6,  9, 10, 10,140,210 },
/* 333 */   { ROOT  "DJ_Marlo.gif",		10, 6,  9, 10, 10,140,210 },
/* 334 */   { ROOT  "DJ_MIKE.gif",		10, 6,  9, 10, 10,140,210 },
/* 335 */   { ROOT  "DJ_Miyuki.gif",		10, 6,  9, 10, 10,140,210 },
/* 336 */   { ROOT  "DJ_Monique.gif",           10, 6,  9, 10, 10,140,210 },
/* 337 */   { ROOT  "DJ_Nifra.gif",             10, 6,  9, 10, 10,140,210 },
/* 338 */   { ROOT  "DJ_Orkidea.gif",		10, 6,  9, 10, 10,140,210 },
/* 339 */   { ROOT  "DJ_Paul_Oakenfold.gif",	10, 6,  9, 10, 10,140,210 },
/* 340 */   { ROOT  "DJ_PaulVanDyk.gif",	10, 6,  9, 10, 10,140,210 },
/* 341 */   { ROOT  "DJ_RDR_lgrey.gif",		10, 0 , 0, 10, 10,128,128 },
/* 342 */   { ROOT  "DJ_Reality_Test.gif",	10, 6,  9, 10, 10,140,210 },
/* 343 */   { ROOT  "DJ_Richard_Durand.gif",    10, 6,  9, 10, 10,140,210 },
/* 344 */   { ROOT  "DJ_Rinaly.gif",		10, 6,  9, 10, 10,140,210 },
/* 345 */   { ROOT  "DJ_Ruben.gif",		10, 0 , 0, 10, 10,128,170 },
/* 346 */   { ROOT  "DJ_Sean_Tyas.gif",		10, 6,  9, 10, 10,140,210 },
/* 347 */   { ROOT  "DJ_Solarstone.gif",	10, 6,  9, 10, 10,140,210 },
/* 348 */   { ROOT  "DJ_Somna.gif",		10, 6,  9, 10, 10,140,210 },
/* 349 */   { ROOT  "DJ_Sony.gif",              10, 6,  9, 10, 10,140,210 },
/* 350 */   { ROOT  "DJ_Susana.gif",		10, 6,  9, 10, 10,140,210 },
/* 351 */   { ROOT  "DJ_Talla-2XLC.gif",	10, 6,  9, 10, 10,140,210 },
/* 352 */   { ROOT  "DJ_Thrillseekers.gif",	10, 6,  9, 10, 10,140,210 },
/* 353 */   { ROOT  "DJ_Triode.gif",	        10, 6,  9, 10, 10,140,210 },
/* 354 */   { ROOT  "DJ_Ulrich.gif",		10, 6,  9, 10, 10,140,210 },
...
/* 389 */ { "", NULL, 269, NULL },
// Demo 310 => 390 (+80)
/* 390 */ { "FIF Anna",		     GifAnim, 270, NULL },
/* 391 */ { "FIF Anna2",             GifAnim, 271, NULL },
/* 392 */ { "FIF Anna3",             GifAnim, 272, NULL },
/* 393 */ { "FIF Anna4",             GifAnim, 273, NULL },
/* 394 */ { "FIF 5",		     GifAnim, 274, NULL },
/* 395 */ { "FIF 6",                 GifAnim, 275, NULL },
/* 396 */ { "FIF 7",                 GifAnim, 276, NULL },
/* 397 */ { "FIF 8",                 GifAnim, 277, NULL },
/* 398 */ { "FIF Thorgodofbass",     GifAnim, 278, NULL },
/* 399 */ { "FIF AmandaVH",          GifAnim, 279, NULL },

/* 400 */ { "DJ 01",                 GifAnim, 280, NULL },
/* 401 */ { "DJ 02",                 GifAnim, 281, NULL },
/* 402 */ { "DJ 03",                 GifAnim, 282, NULL },
/* 403 */ { "DJ 04",                 GifAnim, 283, NULL },
/* 404 */ { "DJ 05",                 GifAnim, 284, NULL },
/* 405 */ { "DJ 06",                 GifAnim, 285, NULL },
/* 406 */ { "DJ 07",                 GifAnim, 286, NULL },
/* 407 */ { "DJ 08",                 GifAnim, 287, NULL },
/* 408 */ { "DJ 09",                 GifAnim, 288, NULL },
/* 409 */ { "DJ 10",                 GifAnim, 289, NULL },

/* 410 */ { "GIF 7lions",            GifAnim, 290, NULL }, // deno 330
/* 411 */ { "GIF Above and Beyond",  GifAnim, 291, NULL },
/* 412 */ { "GIF Afik Cohen",        GifAnim, 292, NULL },
/* 413 */ { "GIF Alessandra Roncone",GifAnim, 293, NULL },
/* 414 */ { "GIF Alex MORPH",        GifAnim, 294, NULL },
/* 415 */ { "GIF Alpha9",            GifAnim, 295, NULL },
/* 416 */ { "GIF Alvin",             GifAnim, 296, NULL },
/* 417 */ { "GIF Aly & Fila",        GifAnim, 297, NULL },
/* 418 */ { "GIF Aly & Fila Fadi",   GifAnim, 298, NULL },
/* 419 */ { "GIF Aname",             GifAnim, 299, NULL },
/* 420 */ { "GIF Andrew Rayel",      GifAnim, 300, NULL }, // demo 340
/* 421 */ { "GIF Andy Moor",         GifAnim, 301, NULL },
/* 422 */ { "GIF Astrix",            GifAnim, 302, NULL },
/* 423 */ { "GIF ATB",               GifAnim, 303, NULL },
/* 424 */ { "GIF AvB",               GifAnim, 304, NULL },
/* 425 */ { "GIF Ben Nicky",         GifAnim, 305, NULL },
/* 426 */ { "GIF Blastoyz",          GifAnim, 306, NULL },
/* 427 */ { "GIF Blur",              GifAnim, 307, NULL },
/* 428 */ { "GIF DJ 11",             GifAnim, 308, NULL },
/* 429 */ { "GIF Bryan Kearney",     GifAnim, 309, NULL },
/* 430 */ { "GIF Ciaran McCauley",   GifAnim, 310, NULL }, // demo 350
/* 431 */ { "GIF Cold Blue",         GifAnim, 311, NULL },
/* 432 */ { "GIF Cosmic Gate",       GifAnim, 312, NULL },
/* 433 */ { "GIF Craig Connelly",    GifAnim, 313, NULL },
/* 434 */ { "GIF Crystal Method",    GifAnim, 314, NULL },
/* 435 */ { "GIF Dave Dresden",      GifAnim, 315, NULL },
/* 436 */ { "GIF Daxson",            GifAnim, 316, NULL },
/* 437 */ { "GIF Emma Hewitt",       GifAnim, 317, NULL },
/* 438 */ { "GIF FactorB",           GifAnim, 318, NULL },
/* 439 */ { "GIF Ferry Corsten",     GifAnim, 319, NULL },
/* 440 */ { "GIF Ferry Tayle",       GifAnim, 320, NULL }, // demo 360
/* 441 */ { "GIF Gareth Emery",      GifAnim, 321, NULL },
/* 442 */ { "GIF Giuseppe",          GifAnim, 322, NULL },
/* 443 */ { "GIF Giuseppe Logo",     GifAnim, 323, NULL },
/* 444 */ { "GIF Haliene",           GifAnim, 324, NULL },
/* 445 */ { "GIF Ilan Bluestone",    GifAnim, 325, NULL },
/* 446 */ { "GIF JOC",               GifAnim, 326, NULL },
/* 447 */ { "GIF Johan Gielen",      GifAnim, 327, NULL },
/* 448 */ { "GIF John 00 Flemming",  GifAnim, 328, NULL },
/* 449 */ { "GIF Khromata",          GifAnim, 329, NULL },
/* 450 */ { "GIF Lange",             GifAnim, 330, NULL }, // demo 370
/* 451 */ { "GIF Liquid Soul",       GifAnim, 331, NULL },
/* 452 */ { "GIF Markus Schulz",     GifAnim, 332, NULL },
/* 453 */ { "GIF Marlo",             GifAnim, 333, NULL },
/* 454 */ { "GIF MIKE",              GifAnim, 334, NULL },
/* 455 */ { "GIF Miyuki",            GifAnim, 335, NULL },
/* 456 */ { "GIF Monique",           GifAnim, 336, NULL },
/* 457 */ { "GIF Nifra",             GifAnim, 337, NULL },
/* 458 */ { "GIF Orkidea",           GifAnim, 338, NULL },
/* 459 */ { "GIF Paul Oakenfold",    GifAnim, 339, NULL },
/* 460 */ { "GIF Paul Van Dyk",      GifAnim, 340, NULL }, // demo 380
/* 461 */ { "GIF RDR Logo",          GifAnim, 341, NULL },
/* 462 */ { "GIF Reality Test",      GifAnim, 342, NULL },
/* 463 */ { "GIF Richard Durand",    GifAnim, 343, NULL },
/* 464 */ { "GIF Rinaly",            GifAnim, 344, NULL },
/* 465 */ { "GIF RubenDeRonde",      GifAnim, 345, NULL },
/* 466 */ { "GIF Sean Tyas",         GifAnim, 346, NULL },
/* 467 */ { "GIF Solarstone",        GifAnim, 347, NULL },
/* 468 */ { "GIF Somna",             GifAnim, 348, NULL },
/* 469 */ { "GIF Sony",              GifAnim, 349, NULL },
/* 470 */ { "GIF Susana",            GifAnim, 350, NULL }, // demo 390
/* 471 */ { "GIF Talla-2XLC",        GifAnim, 351, NULL },
/* 472 */ { "GIF Thrillseekers",     GifAnim, 352, NULL },
/* 473 */ { "GIF Triode",            GifAnim, 353, NULL },
/* 474 */ { "GIF Ulrich",	     GifAnim, 354, NULL },
/* 475 */ { "GIF Vini Vici",         GifAnim, 355, NULL },
/* 476 */ { "GIF WhiteNo1se",        GifAnim, 356, NULL },
/* 477 */ { "GIF Will Atkinson",     GifAnim, 357, NULL },

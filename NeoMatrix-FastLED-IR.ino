...
/* 302 */   { ROOT  "F_Anna2.gif",              10, 0 , 0, 10, 10, 0, 0  },
/* 304 */   { ROOT  "DJ_Monique.gif",           10, 0 , 0, 10, 10, 0, 0  },
/* 304 */   { ROOT  "DJ_BryanKearney.gif",      0, 0 , 0, 10, 10, 0, 0  },
/* 305 */   { ROOT  "F_Anna.gif",               10, 0 , 0, 10, 10, 0, 0  },
/* 306 */   { ROOT  "DJ_Sony.gif",              10, 0 , 0, 10, 10, 0, 0  },
/* 307 */   { ROOT  "F_Rochelle.gif",           10, 0 , 0, 10, 10, 0, 0  },
/* 308 */   { ROOT  "DJ_7lions.gif",	        10, 0 , 0, 10, 10, 0, 0,  },
/* 309 */   { ROOT  "DJ_ATB.gif",		10, 0 , 0, 10, 10, 0, 0,  },
/* 310 */   { ROOT  "DJ_Above_and_Beyond3.gif",	10, 0 , 0, 10, 10, 0, 0  },
/* 311 */   { ROOT  "DJ_Afik_Cohen.gif",	10, 0 , 0, 10, 10, 0, 0  },
/* 312 */   { ROOT  "DJ_Alessandra_Roncone.gif",10, 0 , 0, 10, 10, 0, 0  },
/* 313 */   { ROOT  "DJ_Alex_MORPH.gif",	10, 0 , 0, 10, 10, 0, 0  },
/* 314 */   { ROOT  "DJ_Alpha9.gif",            10, 0 , 0, 10, 10, 0, 0  },
/* 315 */   { ROOT  "DJ_Alvin.gif",		10, 0 , 0, 10, 10, 0, 0  },
/* 316 */   { ROOT  "DJ_Aly_Fila_lgrey.gif",	10, 0 , 0, 10, 10,100,192 },
/* 317 */   { ROOT  "DJ_AlynFila_Fadi.gif",	10, 0 , 0, 10, 10, 0, 0  },
/* 318 */   { ROOT  "DJ_Aname.gif",             10, 0 , 0, 10, 10, 0, 0  },
/* 319 */   { ROOT  "DJ_AndrewRayel.gif",	10, 0 , 0, 10, 10, 0, 0  },
/* 320 */   { ROOT  "DJ_Astrix.gif",		10, 0 , 0, 10, 10, 0, 0  },
/* 321 */   { ROOT  "DJ_AvB.gif",	    	10, 0 , 0, 10, 10, 0, 0  },
/* 322 */   { ROOT  "DJ_Blastoyz.gif",		10, 0 , 0, 10, 10, 0, 0,  },
/* 323 */   { ROOT  "DJ_CosmicGate.gif",	10, 0 , 0, 10, 10, 0, 0  },
/* 324 */   { ROOT  "DJ_Craig_Connelly.gif",	10, 0 , 0, 10, 10, 0, 0,  },
/* 325 */   { ROOT  "DJ_Dave_Dresden.gif",	10, 0 , 0, 10, 10, 0, 0  },
/* 326 */   { ROOT  "DJ_Emma_Hewitt.gif",	10, 0 , 0, 10, 10, 0, 0  },
/* 327 */   { ROOT  "DJ_FactorB.gif",		10, 0 , 0, 10, 10, 0, 0  },
/* 328 */   { ROOT  "DJ_FerryCorsten.gif",	10, 0 , 0, 10, 10, 0, 0  },
/* 329 */   { ROOT  "DJ_Ferry_Tayle.gif",       10, 0 , 0, 10, 10, 0, 0  },
/* 330 */   { ROOT  "DJ_GO_face.gif",		10, 0 , 0, 10, 10, 0, 0  },
/* 331 */   { ROOT  "DJ_GO_lgrey.gif",		10, 0 , 0, 10, 10,128,117 },
/* 332 */   { ROOT  "DJ_GarethEmery.gif",	10, 0 , 0, 10, 10, 0, 0  },
/* 333 */   { ROOT  "DJ_Haliene.gif",		10, 0 , 0, 10, 10, 0, 0  },
/* 334 */   { ROOT  "DJ_Ilan_Bluestone.gif",	10, 0 , 0, 10, 10, 0, 0  },
/* 335 */   { ROOT  "DJ_JOC.gif",		10, 0 , 0, 10, 10, 0, 0,  },
/* 336 */   { ROOT  "DJ_John_00_Flemming.gif",	10, 0 , 0, 10, 10, 0, 0  },
/* 337 */   { ROOT  "DJ_Khromata.gif",		10, 0 , 0, 10, 10, 0, 0  },
/* 338 */   { ROOT  "DJ_Lange.gif",             10, 0 , 0, 10, 10, 0, 0  },
/* 339 */   { ROOT  "DJ_Liquid_Soul.gif",	10, 0 , 0, 10, 10, 0, 0,  },
/* 340 */   { ROOT  "DJ_Markus_Schulz.gif",     10, 0 , 0, 10, 10, 0, 0  },
/* 341 */   { ROOT  "DJ_Marlo.gif",		10, 0 , 0, 10, 10, 0, 0,  },
/* 342 */   { ROOT  "DJ_Miyuki.gif",		10, 0 , 0, 10, 10, 0, 0,  },
/* 343 */   { ROOT  "DJ_Nifra.gif",             10, 0 , 0, 10, 10, 0, 0  },
/* 344 */   { ROOT  "DJ_Paul_Oakenfold.gif",	10, 0 , 0, 10, 10, 0, 0  },
/* 345 */   { ROOT  "DJ_PaulVanDyk.gif",	10, 0 , 0, 10, 10, 0, 0  },
/* 346 */   { ROOT  "DJ_RDR_lgrey.gif",		10, 0 , 0, 10, 10,128,128 },
/* 347 */   { ROOT  "DJ_Reality_Test.gif",	10, 0 , 0, 10, 10, 0, 0  },
/* 348 */   { ROOT  "DJ_Richard_Durand.gif",    10, 0 , 0, 10, 10, 0, 0  },

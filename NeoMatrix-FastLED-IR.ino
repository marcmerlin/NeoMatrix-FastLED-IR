...
/* 280 */   { ROOT  "DJ_01.gif",		10, 6,  9, 10, 10,140,210 },
/* 281 */   { ROOT  "DJ_02.gif",		10, 6,  9, 10, 10,140,210 },
/* 282 */   { ROOT  "DJ_03.gif",		10, 6,  9, 10, 10,140,210 },
/* 283 */   { ROOT  "DJ_04.gif",		10, 6,  9, 10, 10,140,210 },
...
/* 290 */   { ROOT  "DJ_Afik_Cohen.gif",	10, 6,  9, 10, 10,140,210 },
/* 291 */   { ROOT  "DJ_Alessandra_Roncone.gif",10, 6,  9, 10, 10,140,210 },
...
/* 299 */   { ROOT  "DJ_Andy_Moor.gif",		10, 6,  9, 10, 10,140,210 },
/* 300 */   { ROOT  "DJ_Astrix.gif",		10, 6,  9, 10, 10,140,210 },
/* 301 */   { ROOT  "DJ_ATB.gif",		10, 6,  9, 10, 10,140,210 },
/* 302 */   { ROOT  "DJ_AvB.gif",	    	10, 6,  9, 10, 10,140,210 },
/* 303 */   { ROOT  "DJ_Ben_Nicky.gif",		10, 6,  9, 10, 10,140,210 },
/* 304 */   { ROOT  "DJ_Blastoyz.gif",		10, 6,  9, 10, 10,140,210 },
/* 305 */   { ROOT  "DJ_Blur.gif",              10, 6,  9, 10, 10,140,210 },
/* 306 */   { ROOT  "DJ_BryanKearney.gif",      10, 6,  9, 10, 10,140,210 },
/* 307 */   { ROOT  "DJ_Ciaran_McCauley.gif",	10, 6,  9, 10, 10,140,210 },
/* 308 */   { ROOT  "DJ_Cold_Blue.gif",		10, 6,  9, 10, 10,140,210 },
/* 309 */   { ROOT  "DJ_CosmicGate.gif",	10, 6,  9, 10, 10,140,210 },
/* 310 */   { ROOT  "DJ_Craig_Connelly.gif",	10, 6,  9, 10, 10,140,210 },
/* 311 */   { ROOT  "DJ_Crystal_Method.gif",	10, 6,  9, 10, 10,140,210 },
/* 312 */   { ROOT  "DJ_Dave_Dresden.gif",	10, 6,  9, 10, 10,140,210 },
/* 313 */   { ROOT  "DJ_Daxson.gif",            10, 6,  9, 10, 10,140,210 },
/* 314 */   { ROOT  "DJ_Emma_Hewitt.gif",	10, 6,  9, 10, 10,140,210 },
/* 315 */   { ROOT  "DJ_FactorB.gif",		10, 6,  9, 10, 10,140,210 },
/* 316 */   { ROOT  "DJ_FerryCorsten.gif",	10, 6,  9, 10, 10,140,210 },
/* 317 */   { ROOT  "DJ_Ferry_Tayle.gif",       10, 6,  9, 10, 10,140,210 },
/* 318 */   { ROOT  "DJ_Gareth_Emery.gif",	10, 6,  9, 10, 10,140,210 },
/* 319 */   { ROOT  "DJ_Giuseppe.gif",		10, 6,  9, 10, 10,140,210 },
/* 320 */   { ROOT  "DJ_Giuseppe_Logo.gif",	10, 0,  0, 10, 10,128,117 } ,
/* 321 */   { ROOT  "DJ_Haliene.gif",		10, 6,  9, 10, 10,140,210 },
/* 322 */   { ROOT  "DJ_Ilan_Bluestone.gif",	10, 6,  9, 10, 10,140,210 },
/* 323 */   { ROOT  "DJ_JOC.gif",		10, 6,  9, 10, 10,140,210 },
/* 324 */   { ROOT  "DJ_Johan_Gielen.gif",	10, 6,  9, 10, 10,140,210 },
/* 325 */   { ROOT  "DJ_John_00_Flemming.gif",	10, 6,  9, 10, 10,140,210 },
/* 326 */   { ROOT  "DJ_Khromata.gif",		10, 6,  9, 10, 10,140,210 },
/* 327 */   { ROOT  "DJ_Lange.gif",             10, 6,  9, 10, 10,140,210 },
/* 328 */   { ROOT  "DJ_Liquid_Soul.gif",	10, 6,  9, 10, 10,140,210 },
...
/* 336 */   { ROOT  "DJ_Orjan_Nilsen.gif",	10, 6,  9, 10, 10,140,210 },
/* 337 */   { ROOT  "DJ_Orkidea.gif",		10, 6,  9, 10, 10,140,210 },
/* 338 */   { ROOT  "DJ_Paul_Oakenfold.gif",	10, 6,  9, 10, 10,140,210 },
/* 339 */   { ROOT  "DJ_PaulVanDyk.gif",	10, 6,  9, 10, 10,140,210 },
/* 340 */   { ROOT  "DJ_RAM.gif",               10, 6,  9, 10, 10,140,210 },
...
/* 410 */ { "GIF Afik Cohen",        GifAnim, 290, NULL }, // deno 330
/* 411 */ { "GIF Alessandra Roncone",GifAnim, 291, NULL },
/* 412 */ { "GIF Alex MORPH",        GifAnim, 292, NULL },
/* 413 */ { "GIF Alpha9",            GifAnim, 293, NULL },
/* 414 */ { "GIF Alvin",             GifAnim, 294, NULL },
/* 415 */ { "GIF Aly & Fila Fadi",   GifAnim, 295, NULL },
/* 416 */ { "GIF Aly & Fila Logo",   GifAnim, 296, NULL },
/* 417 */ { "GIF Aname",             GifAnim, 297, NULL },
/* 418 */ { "GIF Andrew Rayel",      GifAnim, 298, NULL },
/* 419 */ { "GIF Andy Moor",         GifAnim, 299, NULL },
/* 420 */ { "GIF Astrix",            GifAnim, 300, NULL }, // demo 340
/* 421 */ { "GIF ATB",               GifAnim, 301, NULL },
/* 422 */ { "GIF AvB",               GifAnim, 302, NULL },
/* 423 */ { "GIF Ben Nicky",         GifAnim, 303, NULL },
/* 424 */ { "GIF Blastoyz",          GifAnim, 304, NULL },
/* 425 */ { "GIF Blur",              GifAnim, 305, NULL },
/* 426 */ { "GIF Bryan Kearney",     GifAnim, 306, NULL },
/* 427 */ { "GIF Ciaran McCauley",   GifAnim, 307, NULL },
/* 428 */ { "GIF Cold Blue",         GifAnim, 308, NULL },
/* 429 */ { "GIF Cosmic Gate",       GifAnim, 309, NULL },
/* 430 */ { "GIF Craig Connelly",    GifAnim, 310, NULL }, // demo 350
/* 431 */ { "GIF Crystal Method",    GifAnim, 311, NULL },
/* 432 */ { "GIF Dave Dresden",      GifAnim, 312, NULL },
/* 433 */ { "GIF Daxson",            GifAnim, 313, NULL },
/* 434 */ { "GIF Emma Hewitt",       GifAnim, 314, NULL },
/* 435 */ { "GIF FactorB",           GifAnim, 315, NULL },
/* 436 */ { "GIF Ferry Corsten",     GifAnim, 316, NULL },
/* 437 */ { "GIF Ferry Tayle",       GifAnim, 317, NULL },
/* 438 */ { "GIF Gareth Emery",      GifAnim, 318, NULL },
/* 439 */ { "GIF Giuseppe",          GifAnim, 319, NULL },
/* 440 */ { "GIF Giuseppe Logo",     GifAnim, 320, NULL }, // demo 360
/* 441 */ { "GIF Haliene",           GifAnim, 321, NULL },
/* 442 */ { "GIF Ilan Bluestone",    GifAnim, 322, NULL },
/* 443 */ { "GIF JOC",               GifAnim, 323, NULL },
/* 444 */ { "GIF Johan Gielen",      GifAnim, 324, NULL },
/* 445 */ { "GIF John 00 Flemming",  GifAnim, 325, NULL },
/* 446 */ { "GIF Khromata",          GifAnim, 326, NULL },
/* 447 */ { "GIF Lange",             GifAnim, 327, NULL },
/* 448 */ { "GIF Liquid Soul",       GifAnim, 328, NULL },
...
/* 456 */ { "GIF Orjan Nilsen",      GifAnim, 336, NULL },
/* 457 */ { "GIF Orkidea",           GifAnim, 337, NULL },
/* 458 */ { "GIF Paul Oakenfold",    GifAnim, 338, NULL },
/* 459 */ { "GIF Paul Van Dyk",      GifAnim, 339, NULL },
/* 460 */ { "GIF RAM",               GifAnim, 340, NULL }, // demo 380

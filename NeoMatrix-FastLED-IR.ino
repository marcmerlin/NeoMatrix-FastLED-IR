...
/* 316 */   { ROOT  "DJ_7lions.gif",	        10, 0 , 0, 10, 10, 0, 0,  },
/* 317 */   { ROOT  "DJ_Above_and_Beyond3.gif",	10, 0 , 0, 10, 10, 0, 0  },
/* 318 */   { ROOT  "DJ_Afik_Cohen.gif",	10, 0 , 0, 10, 10, 0, 0  },
/* 319 */   { ROOT  "DJ_Alex_MORPH.gif",	10, 0 , 0, 10, 10, 0, 0  },
/* 320 */   { ROOT  "DJ_Alvin.gif",		10, 0 , 0, 10, 10, 0, 0  },
/* 321 */   { ROOT  "DJ_Aly_Fila_lgrey.gif",	10, 0 , 0, 10, 10,100,192 },
/* 322 */   { ROOT  "DJ_AlynFila_Fadi.gif",	10, 0 , 0, 10, 10, 0, 0  },
/* 323 */   { ROOT  "DJ_AndrewRayel.gif",	10, 0 , 0, 10, 10, 0, 0  },
/* 324 */   { ROOT  "DJ_Astrix.gif",		10, 0 , 0, 10, 10, 0, 0  },
/* 325 */   { ROOT  "DJ_ATB.gif",		10, 0 , 0, 10, 10, 0, 0,  },
/* 326 */   { ROOT  "DJ_AvB.gif",	    	10, 0 , 0, 10, 10, 0, 0  },
/* 327 */   { ROOT  "DJ_Blastoyz.gif",		10, 0 , 0, 10, 10, 0, 0,  },
/* 328 */   { ROOT  "DJ_CosmicGate.gif",	10, 0 , 0, 10, 10, 0, 0  },
/* 329 */   { ROOT  "DJ_Craig_Connelly.gif",	10, 0 , 0, 10, 10, 0, 0,  },
/* 330 */   { ROOT  "DJ_Dave_Dresden.gif",	10, 0 , 0, 10, 10, 0, 0  },
/* 331 */   { ROOT  "DJ_Emma_Hewitt.gif",	10, 0 , 0, 10, 10, 0, 0  },
/* 332 */   { ROOT  "DJ_FactorB.gif",		10, 0 , 0, 10, 10, 0, 0  },
/* 333 */   { ROOT  "DJ_FerryCorsten.gif",	10, 0 , 0, 10, 10, 0, 0  },
/* 334 */   { ROOT  "DJ_GarethEmery.gif",	10, 0 , 0, 10, 10, 0, 0  },
/* 335 */   { ROOT  "DJ_GO_face.gif",		10, 0 , 0, 10, 10, 0, 0  },
/* 336 */   { ROOT  "DJ_GO_lgrey.gif",		10, 0 , 0, 10, 10,128,117 },
/* 337 */   { ROOT  "DJ_Haliene.gif",		10, 0 , 0, 10, 10, 0, 0  },
/* 338 */   { ROOT  "DJ_Ilan_Bluestone.gif",	10, 0 , 0, 10, 10, 0, 0  },
/* 339 */   { ROOT  "DJ_JOC.gif",		10, 0 , 0, 10, 10, 0, 0,  },
/* 340 */   { ROOT  "DJ_John_00_Flemming.gif",	10, 0 , 0, 10, 10, 0, 0  },
/* 341 */   { ROOT  "DJ_Khromata.gif",		10, 0 , 0, 10, 10, 0, 0  },
/* 342 */   { ROOT  "DJ_Liquid_Soul.gif",	10, 0 , 0, 10, 10, 0, 0,  },
/* 343 */   { ROOT  "DJ_Marlo.gif",		10, 0 , 0, 10, 10, 0, 0,  },
/* 344 */   { ROOT  "DJ_Miyuki.gif",		10, 0 , 0, 10, 10, 0, 0,  },
/* 345 */   { ROOT  "DJ_PaulOakenfold.gif",	10, 0 , 0, 10, 10, 0, 0  },
/* 346 */   { ROOT  "DJ_PaulVanDyk.gif",	10, 0 , 0, 10, 10, 0, 0  },
/* 347 */   { ROOT  "DJ_RDR_lgrey.gif",		10, 0 , 0, 10, 10,128,128 },
/* 348 */   { ROOT  "DJ_Reality_Test.gif",	10, 0 , 0, 10, 10, 0, 0  },
/* 349 */   { ROOT  "DJ_Rinaly.gif",		10, 0 , 0, 10, 10, 0, 0  },
/* 350 */   { ROOT  "DJ_Ruben.gif",		10, 0 , 0, 10, 10,128,170 },
/* 351 */   { ROOT  "DJ_Solarstone.gif",	10, 0 , 0, 10, 10, 0, 0,  },
/* 352 */   { ROOT  "DJ_Somna.gif",		10, 0 , 0, 10, 10, 0, 0  },
/* 353 */   { ROOT  "DJ_Susana.gif",		10, 0 , 0, 10, 10, 0, 0  },
...
/* 435 */ { "", NULL, 315, NULL },
// Demo 356
/* 436 */ { "GIF 7lions",            GifAnim, 316, NULL },
/* 437 */ { "GIF Above and Beyond",  GifAnim, 317, NULL },
/* 438 */ { "GIF Afik Cohen",        GifAnim, 318, NULL },
/* 439 */ { "GIF Alex MORPH",        GifAnim, 319, NULL },
/* 440 */ { "GIF Alvin",             GifAnim, 320, NULL }, // demo 360
/* 441 */ { "GIF Aly & Fila",        GifAnim, 321, NULL },
/* 442 */ { "GIF Aly & Fila Fadi",   GifAnim, 322, NULL },
/* 443 */ { "GIF Andrew Rayel",      GifAnim, 323, NULL },
/* 444 */ { "GIF Astrix",            GifAnim, 324, NULL },
/* 445 */ { "GIF ATB",               GifAnim, 325, NULL },
/* 446 */ { "GIF AvB",               GifAnim, 326, NULL },
/* 447 */ { "GIF Blastoyz",          GifAnim, 327, NULL },
/* 448 */ { "GIF Cosmic Gate",       GifAnim, 328, NULL },
/* 449 */ { "GIF Craig Connelly",    GifAnim, 329, NULL },
/* 450 */ { "GIF Dave Dresden",      GifAnim, 330, NULL }, // demo 370
/* 451 */ { "GIF Emma Hewitt",       GifAnim, 331, NULL },
/* 452 */ { "GIF FactorB",           GifAnim, 332, NULL },
/* 453 */ { "GIF Ferry Corsten",     GifAnim, 333, NULL },
/* 454 */ { "GIF Gareth Emery",      GifAnim, 334, NULL },
/* 455 */ { "GIF Giuseppe",          GifAnim, 335, NULL },
/* 456 */ { "GIF Giuseppe Logo",     GifAnim, 336, NULL },
/* 457 */ { "GIF Haliene",           GifAnim, 337, NULL },
/* 458 */ { "GIF Ilan Bluestone",    GifAnim, 338, NULL },
/* 459 */ { "GIF JOC",               GifAnim, 339, NULL },
/* 460 */ { "GIF John 00 Flemming",  GifAnim, 340, NULL }, // demo 380
/* 461 */ { "GIF Khromata",          GifAnim, 341, NULL },
/* 462 */ { "GIF Liquid Soul",       GifAnim, 342, NULL },
/* 463 */ { "GIF Marlo",             GifAnim, 343, NULL },
/* 464 */ { "GIF Miyuki",            GifAnim, 344, NULL },
/* 465 */ { "GIF Paul Oakenfold",    GifAnim, 345, NULL },
/* 466 */ { "GIF Paul Van Dyk",      GifAnim, 346, NULL },
/* 467 */ { "GIF RDR Logo",          GifAnim, 347, NULL },
/* 468 */ { "GIF Reality Test",      GifAnim, 348, NULL },
